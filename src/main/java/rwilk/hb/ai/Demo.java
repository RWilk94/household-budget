...
public class Demo {
  ...
  public static Instances getDataSet(String fileName) throws IOException {
    ...
    loader.setSource(Demo.class.getResourceAsStream("/" + fileName));
    /*
  ...
  public static void process() throws Exception {
    ...
    for (int i = 0; i < getDataSet(PREDICTION_DATA_SET_FILENAME).size(); i++) {
      Instance predicationDataSet = getDataSet(PREDICTION_DATA_SET_FILENAME).get(i);
...
//
//    predicationDataSet = getDataSet(PREDICTION_DATA_SET_FILENAME).;
